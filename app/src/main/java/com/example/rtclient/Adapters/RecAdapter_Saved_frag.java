...
public class RecAdapter_Saved_frag extends RecyclerView.Adapter<RecAdapter_Saved_frag.ViewHolder> {
    ...
    public RecAdapter_Saved_frag(Activity mContext, List<FeedData> mUsers) {
    ...
    @NonNull
    @Override
    public RecAdapter_Saved_frag.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.recycler_item_saved_fragment, parent, false);
        return new RecAdapter_Saved_frag.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecAdapter_Saved_frag.ViewHolder holder, int position) {
        ...
        holder.bookmarkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reference.child(data.getPushId()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            getDialog.dismiss();
                            Toast.makeText(mContext, "Succeed! news Removed from your Saved list ", Toast.LENGTH_SHORT).show();
                        }else {
                            getDialog.dismiss();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tv1_title    = itemView.findViewById(R.id.tv1_title_recycler_item_saved_frag);
            tv2_subtitle = itemView.findViewById(R.id.tv2_subtitle_recycler_item_saved_frag);
            tv3_country  = itemView.findViewById(R.id.tv3_country_recycler_item_saved_frag);
            tv4_state    = itemView.findViewById(R.id.tv4_state_recycler_item_saved_frag);
            tv5_time     = itemView.findViewById(R.id.tv5_time_recycler_item_saved_frag);
            imageview    = itemView.findViewById(R.id.iv_recycler_item_saved_frag);
            videoIcon    = itemView.findViewById(R.id.play_btn_recycler_item_saved_frag);
            bookmarkBtn  = itemView.findViewById(R.id.btn_bookmark_recycler_item_saved_frag);
            shareBtn     = itemView.findViewById(R.id.btn_share_recycler_item_saved_frag);
