...
//    strip payment method
    ...
    public void initilize(View view){
        recyclerView = view.findViewById(R.id.recyclerview_id_feed_frag);
        emptyTv = view.findViewById(R.id.empty_tv_feed_frag);
        filterBtn = view.findViewById(R.id.filter_btn_feed_frag);
            ...
            listener =  reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataList.isEmpty()){
                        ...
                        RecAdapter_Feed_frag adapter = new RecAdapter_Feed_frag(getActivity(), dataList);
